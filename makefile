...
import/websites/gr.maharashtra.gov.in/Environment:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Environment .
...
import: check_env import/websites/gr.maharashtra.gov.in/Environment .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Environment import/documents
